"""
Django settings for taxi_rideshare_42366 project.
...
ROOT_URLCONF = 'taxi_rideshare_42366.urls'
...
WSGI_APPLICATION = 'taxi_rideshare_42366.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taxi_rideshare_42366 API",
    "DESCRIPTION": "API documentation for taxi_rideshare_42366 App",
    "VERSION": "v1",
}
